...
class pos_config(models.Model):
    ...
    keyboard_price = fields.Char('Shortcut price', default='ctrl+p')
    keyboard_quantity = fields.Char('Shortcut quantity', default='ctrl+q')
    keyboard_discount = fields.Char('Shortcut discount', default='ctrl+d')
    keyboard_search = fields.Char('Shortcut search box', default='ctrl+s')
    keyboard_payment = fields.Char('Shortcut payment', default='ctrl+m')
    keyboard_new_order = fields.Char('Shortcut new order', default='ctrl+n')
    keyboard_remove_order = fields.Char('Shortcut remove order', default='ctrl+r')
    keyboard_add_client = fields.Char('Shortcut add customer', default='ctrl+c')
    ...
    management_isurance = fields.Boolean('Medical insurance')
    ...
    def remove_database(self):
        ...
        self.env.cr.execute("DELETE FROM pos_database")
        return {
